...
import { D as DEFAULT_TIMELINE_FILTER, g as graphqlRequest, S as SAVE_FILTER_MUTATION, E as EDIT_SAVED_FILTER_MUTATION, a as DELETE_SAVED_FILTER_MUTATION, b as SAVED_FILTERS_QUERY, u as useAuth, c as useTimelineFilter, d as useEra, B as Button, p as parseView, f as filterToSearchParams, e as getGroupSlugFromId, t as themes, h as collapseData } from "./server-build-CRQT8O9S.js";
import { AnimatePresence, motion } from "framer-motion";
import { h as hasActiveState } from "./filterUtils-CXGZbkdZ.js";
...
function SavedFilters() {
  ...
  if (!isAuth.token) {
    return /* @__PURE__ */ jsx(DrawerCollapse, { title: "Saved Filters", count: 0, children: /* @__PURE__ */ jsxs("div", { className: "p-4 text-center space-y-2", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm text-stone-400", children: "Log in to save and manage your custom filters" }),
      /* @__PURE__ */ jsx(
        Button,
        {
          primary: true,
