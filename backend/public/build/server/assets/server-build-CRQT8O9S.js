...
function getApiOrigin() {
  if (typeof window === "undefined") {
    return process.env.API_ORIGIN || process.env.VITE_API_ORIGIN || "http://localhost:5000";
  }
  return "";
}
...
function Background() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "fixed inset-x-0 top-0 h-[100lvh] sm:inset-0 sm:h-auto z-0 pointer-events-none overflow-hidden", children: /* @__PURE__ */ jsx(
      "img",
      {
        src: "/bg-home.webp",
        alt: "",
...
function RootLayout() {
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen w-full relative", children: [
    ...
    /* @__PURE__ */ jsx(Nav, {}),
    /* @__PURE__ */ jsx("div", { className: "relative z-10 w-full", children: /* @__PURE__ */ jsx(Outlet, {}) })
  ] });
}
...
const home = UNSAFE_withComponentProps(function HomeRoute() {
  return /* @__PURE__ */ jsxs(PageContainer, {
    children: [/* @__PURE__ */ jsx("section", {
      ...
      children: /* @__PURE__ */ jsxs("div", {
        className: "grid gap-6 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)]",
        children: [/* @__PURE__ */ jsxs("div", {
...
function TimelineHeader({ filter }) {
  ...
  return /* @__PURE__ */ jsx(HeaderContainer, { children: /* @__PURE__ */ jsxs("div", { className: "relative z-10 h-full flex flex-col justify-center text-center", children: [
    sortedYears && /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-x-2 gap-y-1", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-baseline justify-center min-w-[8rem] sm:min-w-[9rem] md:min-w-[10rem] ", children: /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-2 tabular-nums", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1 min-w-[4.5rem] sm:min-w-[5rem] md:min-w-[5.8rem] justify-end", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1 min-w-[4rem] sm:min-w-[4.5rem] md:min-w-[5rem] justify-start", children: [
...
async function graphqlRequest(query, variables, apiOrigin) {
  try {
...
const PostModal$1 = lazy(
  () => import("./TimelineModal-VllS8SQu.js")
);
  ...
  return /* @__PURE__ */ jsx(
    "aside",
    {
      ...
      children: /* @__PURE__ */ jsx(
        "div",
        {
          className: `${timeline2 ? "grid grid-cols-[29%_auto_33%] sm:grid-cols-1 sm:grid-rows-[28%_32%_40%]" : "grid grid-cols-3 sm:grid-cols-1 sm:grid-rows-3"} stats sm:stats-vertical w-full h-full bg-gradient-to-br from-stats-primary to-stats-secondary border-t sm:border-l border-stone-800 shadow-lg shadow-stone-950/20 py-1 sm:py-0 rounded-none overflow-hidden`,
          children
        }
      )
    }
...
const MapModal = lazy(() => import("./MapModal-DNubadXA.js"));
...
const Drawer = lazy(() => import("./Drawer-BJ2sdIyp.js"));
const UtilityMenu = lazy(() => import("./UtilityMenu-XgMyZg4I.js"));
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      "main",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-0 bg-base" }),
          /* @__PURE__ */ jsx("div", { className: "relative z-10 p-4 sm:p-6", children: /* @__PURE__ */ jsx(Outlet, {}) }),
          /* @__PURE__ */ jsx("div", { className: "fixed z-40 right-1 bottom-[calc(7rem+env(safe-area-inset-bottom))] sm:right-auto sm:top-auto sm:bottom-4 sm:left-1/2 sm:-translate-x-1/2", children: /* @__PURE__ */ jsx(Suspense, { fallback: null, children: /* @__PURE__ */ jsx(AnimatePresence, { children: /* @__PURE__ */ jsx(UtilityMenu, { onOpenDrawer: () => setDrawerOpen(true) }) }) }) })
        ]
      }
    ),
...
const PostModal = lazy(() => import("./TimelineModal-VllS8SQu.js"));
...
function TimelineTabs({
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      id,
      className: `pb-2 px-2 text-base sm:text-lg transition z-50 ${active ? "border-b-3 border-gold font-bold text-gold" : "font-semibold text-stone-400 hover:text-stone-500"}`,
      children
    }
  );
}
                ...
                children: [/* @__PURE__ */ jsx("thead", {
                  ...
                  children: /* @__PURE__ */ jsxs("tr", {
                    children: [/* @__PURE__ */ jsx("th", {
                      className: "px-2 py-4 text-xs font-semibold uppercase tracking-[0.16em] text-stone-400 sm:px-6",
                      children: "Category"
                    }), /* @__PURE__ */ jsx("th", {
                      className: "px-2 py-4 text-xs font-semibold uppercase tracking-[0.16em] text-stone-400 sm:px-6",
                      children: "Examples"
                  ...
                  className: "divide-y divide-stone-800 text-sm sm:text-base leading-6 sm:leading-8",
                  children: [/* @__PURE__ */ jsxs("tr", {
                    className: "align-top",
                    children: [/* @__PURE__ */ jsx("td", {
                      className: "px-2 sm:py-5 py-4 font-semibold text-stone-200 sm:px-6",
                      children: "A. Identifiers"
                    }), /* @__PURE__ */ jsx("td", {
                      className: "px-2 sm:py-5 py-4 text-stone-300 sm:px-6",
                      ...
                      className: "px-2 sm:py-5 py-4 sm:px-6",
                      children: /* @__PURE__ */ jsx("span", {
                        className: "inline-flex rounded-full border border-gold bg-gold-hover px-3 py-1 text-xs font-semibold uppercase tracking-wide text-stone-200",
                        children: "YES"
                      })
                    })]
                  }), /* @__PURE__ */ jsxs("tr", {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-D0FeqjWV.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/index-B4b5WdU2.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/root-HA29myvo.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/index-B4b5WdU2.js", "/assets/api-IZa0Uo5G.js", "/assets/queryClient-BghMot9I.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/ToastContext-CtuTdZap.js", "/assets/icons-BqHPv0b5.js", "/assets/proxy-DZXW7wcI.js", "/assets/query-DrMSeE6t.js", "/assets/mutation-vgu_P7A0.js"], "css": ["/assets/root-DeotB8Pd.css"], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/app-layout": { "id": "routes/app-layout", "parentId": "root", "path": void 0, "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": true, "module": "/assets/app-layout-Dn3GzFJJ.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/Error-P4ch0YjD.js", "/assets/Button-DKCewfr6.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/proxy-DZXW7wcI.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/home": { "id": "routes/home", "parentId": "routes/app-layout", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/home-Cmg_mlas.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/seo-C7rmy-Hb.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/proxy-DZXW7wcI.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/timeline": { "id": "routes/timeline", "parentId": "routes/app-layout", "path": "timeline", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/timeline-D0JFGraS.js", "imports": ["/assets/timeline-D105V5S9.js", "/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/EraContext-Cu8eMH_P.js", "/assets/historicalRanges-Bu_cnujR.js", "/assets/index-CSEDqMJI.js", "/assets/queries-Dlp3JAt7.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/query-DrMSeE6t.js", "/assets/gql-BYRUW5kV.js", "/assets/StatsContainer-CZn6RaYG.js", "/assets/useQuery-DugFaLo_.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/timeline.index": { "id": "routes/timeline.index", "parentId": "routes/timeline", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/timeline.index-DJJeD2OV.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/Timeline-B0xUcspM.js", "/assets/EraContext-Cu8eMH_P.js", "/assets/seo-C7rmy-Hb.js", "/assets/TimelineCard-p0rGynG1.js", "/assets/index-CSEDqMJI.js", "/assets/queries-Dlp3JAt7.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/query-DrMSeE6t.js", "/assets/gql-BYRUW5kV.js", "/assets/CardFooter-BzhvsEa8.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/ToastContext-CtuTdZap.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/queryClient-BghMot9I.js", "/assets/formatDate-BfYLC3VS.js", "/assets/Skeleton-Bwx0KmoU.js", "/assets/historicalRanges-Bu_cnujR.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/timeline.$groupSlug": { "id": "routes/timeline.$groupSlug", "parentId": "routes/timeline", "path": ":groupSlug", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/timeline._groupSlug-DnFf4xKz.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/Timeline-B0xUcspM.js", "/assets/EraContext-Cu8eMH_P.js", "/assets/seo-C7rmy-Hb.js", "/assets/TimelineCard-p0rGynG1.js", "/assets/index-CSEDqMJI.js", "/assets/queries-Dlp3JAt7.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/query-DrMSeE6t.js", "/assets/gql-BYRUW5kV.js", "/assets/CardFooter-BzhvsEa8.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/ToastContext-CtuTdZap.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/queryClient-BghMot9I.js", "/assets/formatDate-BfYLC3VS.js", "/assets/Skeleton-Bwx0KmoU.js", "/assets/historicalRanges-Bu_cnujR.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/register": { "id": "routes/register", "parentId": "routes/app-layout", "path": "register", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/register-DMJkZMjj.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/useAuthMutations-U3Bh5rSE.js", "/assets/schemas-B-AyO3lh.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/Button-DKCewfr6.js", "/assets/ToastContext-CtuTdZap.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/seo-C7rmy-Hb.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/gql-BYRUW5kV.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/login": { "id": "routes/login", "parentId": "routes/app-layout", "path": "login", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/login-DhjDTRi9.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/useAuthMutations-U3Bh5rSE.js", "/assets/schemas-B-AyO3lh.js", "/assets/Button-DKCewfr6.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/ToastContext-CtuTdZap.js", "/assets/seo-C7rmy-Hb.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/gql-BYRUW5kV.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/forgot-password": { "id": "routes/forgot-password", "parentId": "routes/app-layout", "path": "forgot-password", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/forgot-password-DWpT-tqf.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/useAuthMutations-U3Bh5rSE.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/Button-DKCewfr6.js", "/assets/ToastContext-CtuTdZap.js", "/assets/seo-C7rmy-Hb.js", "/assets/schemas-B-AyO3lh.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/gql-BYRUW5kV.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/reset-password": { "id": "routes/reset-password", "parentId": "routes/app-layout", "path": "reset-password", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/reset-password-DbllS5dW.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/useAuthMutations-U3Bh5rSE.js", "/assets/schemas-B-AyO3lh.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/Button-DKCewfr6.js", "/assets/ToastContext-CtuTdZap.js", "/assets/seo-C7rmy-Hb.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/gql-BYRUW5kV.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/verify": { "id": "routes/verify", "parentId": "routes/app-layout", "path": "verify", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/verify-CFlCeQkO.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/useAuthMutations-U3Bh5rSE.js", "/assets/Button-DKCewfr6.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/ToastContext-CtuTdZap.js", "/assets/seo-C7rmy-Hb.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/gql-BYRUW5kV.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/user.$id": { "id": "routes/user.$id", "parentId": "routes/app-layout", "path": "user/:id", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/user._id-DhYYr0_8.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/seo-C7rmy-Hb.js", "/assets/StatsContainer-CZn6RaYG.js", "/assets/formatDate-BfYLC3VS.js", "/assets/useQuery-DugFaLo_.js", "/assets/gql-BYRUW5kV.js", "/assets/queries-Dlp3JAt7.js", "/assets/TimelineCard-p0rGynG1.js", "/assets/StatCard-C4LNkUp6.js", "/assets/historicalRanges-Bu_cnujR.js", "/assets/index-CSEDqMJI.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/query-DrMSeE6t.js", "/assets/CardFooter-BzhvsEa8.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/ToastContext-CtuTdZap.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/queryClient-BghMot9I.js", "/assets/Skeleton-Bwx0KmoU.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/articles": { "id": "routes/articles", "parentId": "routes/app-layout", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/articles-CHRbFs12.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/articles.create": { "id": "routes/articles.create", "parentId": "routes/articles", "path": "create", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/articles.create-JoWijXjN.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/useSuggestions-CwkmFuLC.js", "/assets/useCreate-DhUjKlCf.js", "/assets/ToastContext-CtuTdZap.js", "/assets/PostForm-BNqdTfaB.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/seo-C7rmy-Hb.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/useQuery-DugFaLo_.js", "/assets/queries-Dlp3JAt7.js", "/assets/query-DrMSeE6t.js", "/assets/gql-BYRUW5kV.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/schemas-B-AyO3lh.js", "/assets/index-BN5bp5im.js", "/assets/Button-DKCewfr6.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/articles.edit.$id": { "id": "routes/articles.edit.$id", "parentId": "routes/articles", "path": "edit/:id", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/articles.edit._id-CiAscnxy.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/seo-C7rmy-Hb.js", "/assets/useSuggestions-CwkmFuLC.js", "/assets/useEdit-D2CJPIf1.js", "/assets/ToastContext-CtuTdZap.js", "/assets/PostForm-BNqdTfaB.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/useQuery-DugFaLo_.js", "/assets/queries-Dlp3JAt7.js", "/assets/query-DrMSeE6t.js", "/assets/gql-BYRUW5kV.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/schemas-B-AyO3lh.js", "/assets/index-BN5bp5im.js", "/assets/Button-DKCewfr6.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/review-suggestions": { "id": "routes/review-suggestions", "parentId": "routes/app-layout", "path": "review-suggestions", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/review-suggestions-BuWm7Ojh.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/useSuggestions-CwkmFuLC.js", "/assets/StatsContainer-CZn6RaYG.js", "/assets/StatCard-C4LNkUp6.js", "/assets/useEdit-D2CJPIf1.js", "/assets/Button-DKCewfr6.js", "/assets/Skeleton-Bwx0KmoU.js", "/assets/formatDate-BfYLC3VS.js", "/assets/useCreate-DhUjKlCf.js", "/assets/seo-C7rmy-Hb.js", "/assets/AuthContext-BoYpVt9p.js", "/assets/ToastContext-CtuTdZap.js", "/assets/api-IZa0Uo5G.js", "/assets/proxy-DZXW7wcI.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/useQuery-DugFaLo_.js", "/assets/queries-Dlp3JAt7.js", "/assets/query-DrMSeE6t.js", "/assets/gql-BYRUW5kV.js", "/assets/mutations-DF5AKuKe.js", "/assets/mutation-vgu_P7A0.js", "/assets/index-CSEDqMJI.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/terms": { "id": "routes/terms", "parentId": "routes/app-layout", "path": "terms", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/terms-DrTEV_aJ.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/seo-C7rmy-Hb.js", "/assets/proxy-DZXW7wcI.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/privacy": { "id": "routes/privacy", "parentId": "routes/app-layout", "path": "privacy", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/privacy-aA2VjJJM.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/seo-C7rmy-Hb.js", "/assets/proxy-DZXW7wcI.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/cookies": { "id": "routes/cookies", "parentId": "routes/app-layout", "path": "cookies", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/cookies-eAnvE2tS.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/seo-C7rmy-Hb.js", "/assets/proxy-DZXW7wcI.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/not-found": { "id": "routes/not-found", "parentId": "routes/app-layout", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasDefaultExport": true, "hasErrorBoundary": false, "module": "/assets/not-found-D4ZWBVML.js", "imports": ["/assets/chunk-OE4NN4TA-D45wUbcD.js", "/assets/Error-P4ch0YjD.js", "/assets/seo-C7rmy-Hb.js", "/assets/Button-DKCewfr6.js", "/assets/PageContainer-BuDiT2Z2.js", "/assets/proxy-DZXW7wcI.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 } }, "url": "/assets/manifest-e64771d9.js", "version": "e64771d9", "sri": void 0 };
...
export {
  ...
  useTimelineFilter as c,
  useEra as d,
  getGroupSlugFromId as e,
