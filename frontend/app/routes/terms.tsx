...
export function meta({}: Route.MetaArgs) {
  return buildMeta({
    ...
    description:
      "Review the TLDR History terms of service, including the rules, responsibilities, and conditions for using the platform.",
    path: "/terms",
    type: "website",
  });
}
        ...
        <div className="mx-auto flex max-w-2xl flex-col gap-4 rounded-xl border border-stone-900 bg-gradient-to-br from-stone-800 via-stone-900 to-stone-950 p-4 shadow-xl shadow-stone-950/40 sm:gap-5 sm:p-6">
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <p>
                We are Robert Morgan ('Company', 'we', 'us', or 'our'), a
                company registered in the United Kingdom at Hill View,
              ...
              <p>
                This application is an interactive timeline platform that allows
                users to explore historical events, filter and search content,
                and create, manage, and share their own posts and timelines.
              </p>

              <p>
                You can contact us by phone at +639543954764, email at{" "}
                <a
                ...
                , or by mail to Hill View, Cardiff, South Glamorgan CF5 3UB,
                United Kingdom.
              </p>
              ...
              <p>
                ...
                ('you'), and Robert Morgan, concerning your access to and use of
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a
                    ...
                    className="block p-3 rounded-lg border border-stone-800 hover:bg-stone-700/50 hover:border-stone-600 transition-all duration-200 text-stone-400 hover:text-stone-200 text-sm"
                  >
                    25. PROHIBITION OF DATA EXTRACTION AND SCRAPING
                  </a>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    className="block p-3 rounded-lg border border-stone-800 hover:bg-stone-700/50 hover:border-stone-600 transition-all duration-200 text-stone-400 hover:text-stone-200 text-sm"
                  >
                    27. SERVICE MODIFICATIONS AND AVAILABILITY
                  </a>
                </li>
                <li>
                  <a
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <h3 className="font-semibold text-stone-200 mb-3 text-lg">
              ...
              <ul className="space-y-2 pl-5 mt-3 mb-4 text-stone-300 marker:text-stone-500 list-disc">
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <ul className="space-y-3 pl-5 text-stone-300 marker:text-stone-500 list-disc">
                ...
                <li>
                  Posting false, misleading, or intentionally inaccurate
                  historical content
                </li>
                <li>Uploading copyrighted material without permission</li>
                <li>Scraping or copying your database/timeline content</li>
                <li>
                  Attempting to reverse engineer or exploit your system
                  (important since you're a dev platform)
                </li>
                <li>Harassment, hate speech, or abusive content</li>
                <li>Spamming (especially if users can submit entries)</li>
              </ul>
            </div>
          </section>
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <p>
                ...
                country to residence. Robert Morgan and yourself both agree to
                submit to the non-exclusive jurisdiction of the courts of
                London, which means that you may make a claim to defend your
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <p>
                ...
                constitutes acceptance. The seat of arbitration shall be London,
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <p>
                ...
                educational purposes only. While we strive for accuracy, we make
                no representations or warranties of any kind regarding the
                completeness, reliability, or accuracy of any content. Users
                acknowledge that any reliance on such information is at their
                own risk.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <p>
                Users agree not to access, collect, copy, or extract data from
                the platform through automated means (including bots, scripts,
                or crawlers) or through manual methods intended to replicate
                substantial portions of the platform’s content or structure
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <p>
                All content, features, functionality, design, and structure of
                the platform are and remain the exclusive property of the
                platform owner, unless otherwise stated. Users may not
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <p>
                ...
                of the platform at any time, with or without notice. We do not
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <p>
                We reserve the right to suspend or terminate user accounts at
                our sole discretion, including where users violate these Terms
                or engage in conduct that may harm the platform or other users.
              </p>
            </div>
          </section>
          <section
