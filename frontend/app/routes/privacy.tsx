...
export function meta({}: Route.MetaArgs) {
  return buildMeta({
    ...
    description:
      "Read the TLDR History privacy policy to understand how personal data is collected, used, and protected.",
    path: "/privacy",
    type: "website",
  });
}
      ...
      <div className="py-16 sm:py-24 p-4 sm:p-6 z-10">
        ...
        <div className="mx-auto flex max-w-2xl flex-col gap-4 rounded-xl border border-stone-900 bg-gradient-to-br from-stone-800 via-stone-900 to-stone-950 p-4 shadow-xl shadow-stone-950/40 sm:gap-5 sm:p-6">
          <div className="space-y-5 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
            ...
            <p>
              This Privacy Notice for Robert Morgan ('we', 'us', or 'our'),
            ...
            <ul className="space-y-3 pl-5 text-stone-300 marker:text-stone-500 list-disc">
              ...
              <li>
                Use TLDR History. This application is an interactive timeline
                platform that allows users to explore historical events, filter
                and search content, and create, manage, and share their own
                posts and timelines.
              </li>
              <li>
          ...
          <div className="space-y-6">
            <div className="pt-1">
              <h2 className="text-2xl font-serif font-semibold tracking-wide text-stone-200/90 text-shadow-sm mb-4">
            ...
            <div className="space-y-4">
              <div className="group">
                <dt className="font-medium text-stone-200 tracking-wide">
                  What personal information do we process?
                </dt>
                <dd className="mt-1 text-sm leading-7 text-stone-400 sm:text-base sm:leading-8">
          ...
          <div className="space-y-12 pt-12">
            <section>
              <h2 className="text-2xl font-serif font-semibold tracking-wide text-stone-200/90 text-shadow-sm mb-6">
                TABLE OF CONTENTS
              </h2>
          ...
          <section id="section1" className="space-y-8 pt-12">
            <div>
              <h2 className="text-2xl font-serif font-semibold tracking-wide text-stone-200/90 text-shadow-sm mb-2">
                1. WHAT INFORMATION DO WE COLLECT?
              </h2>
              <p className="text-lg font-medium text-stone-300 mb-6">
                Personal information you disclose to us
              </p>
              <p className="text-sm font-medium italic text-stone-400 uppercase tracking-wide mb-4">
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <div>
                <p className="font-medium text-stone-200 mb-3">
                ...
                <ul className="space-y-2 pl-5 text-stone-300 marker:text-stone-500 list-disc">
              ...
              <p className="font-medium text-stone-200 mb-2">
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <ul className="space-y-4 pl-5 text-stone-300 marker:text-stone-500 list-disc">
                <li>
          ...
          >
            <div>
              ...
              <p className="text-sm font-medium italic text-stone-400 uppercase tracking-wide mb-6">
            ...
            <div className="space-y-8 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <div>
                ...
                <div className="space-y-4 pl-5">
                  <div>
                    <strong className="text-stone-100 block font-medium mb-1">
                      Consent.
                    </strong>
                    <span>
                  ...
                  <div>
                    ...
                    <span>
                      ...
                      it is necessary to fulfil our contractual obligations to
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <p>
                ...
                submitting a request as described below under section {" "} <a href="#section11" className="text-stone-100 underline decoration-stone-500 underline-offset-4 transition hover:text-white hover:decoration-stone-300 font-medium">'DO UNITED
                STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?'</a>
              </p>

              <p>
                Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: {" "}<a href="/cookies" className="text-stone-100 underline decoration-stone-500 underline-offset-4 transition hover:text-white hover:decoration-stone-300 font-medium">https://tldrhistory.xyz/cookies</a>.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <div>
                <p className="font-semibold text-stone-200 mb-3">
                  Account Information
                </p>
                <p>
                ...
                <ul className="space-y-2 pl-5 mt-3 text-stone-300 marker:text-stone-500 list-disc">
          ...
          >
            ...
            <div className="space-y-10 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <h3 className="text-xl font-serif font-semibold tracking-wide text-stone-200/90 mb-4">
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <div>
                <p className="font-semibold text-stone-200 mb-3">Category A</p>
                <p>As long as the user has an account with us.</p>
              </div>
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <p>
                ...
                considered to be <span className="italic">'selling'</span> of
              ...
              <div>
                <h3 className="text-lg font-semibold text-stone-200 mb-4 mt-8">
                  Your Rights
                </h3>
                <p className="mb-6">
                ...
                <ul className="space-y-2 pl-5 mb-8 text-stone-300 marker:text-stone-500 list-disc">
                  <li>
                  ...
                  <li>
                    ...
                    <span className="italic">'profiling'</span>)
                  </li>
                </ul>
                ...
                <ul className="space-y-2 pl-5 mt-4 mb-8 text-stone-300 marker:text-stone-500 list-disc">
                  <li>
                  ...
                  <li>
                    ...
                    law, including the privacy law in Minnesota and Oregon)
                  </li>
                  <li>
                    Right to obtain a list of third parties to which we have
                    sold personal data (as permitted by applicable law,
                    including the privacy law in Connecticut)
                  </li>
                  <li>
                    Right to review, understand, question, and depending on
                    where you live, correct how personal data has been profiled
                ...
                <div>
                  <h4 className="text-base font-semibold text-stone-200 mb-4">
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <div>
                ...
                <p>
                  ...
                  <span className="italic">'Shine The Light'</span> law, permits
            ...
            <div className="space-y-10 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              <div>
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2 pl-5 marker:text-stone-500 list-disc">
              ...
              <div>
                ...
                <div className="bg-stone-700/30 border border-stone-600 rounded-lg p-6">
                  <p className="font-medium text-stone-200 mb-2">
          ...
          >
            ...
            <div className="space-y-6 text-sm leading-7 text-stone-300 sm:text-base sm:leading-8">
              ...
              <div className="bg-stone-700/50 border border-stone-600 rounded-lg p-6">
                ...
                <p className="text-stone-300">Hill View</p>
                <p className="text-stone-300">
                  Cardiff, South Glamorgan CF5 3UB
                </p>
                <p className="text-stone-300 font-medium">United Kingdom</p>
              </div>
            </div>
          </section>
