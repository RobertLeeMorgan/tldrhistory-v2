    ...
    <nav className="navbar fixed top-0 z-50 w-full px-4 md:pr-8 pl-4">
      <div className="flex justify-between w-full">
        ...
        <div className={`navbar-start ${isHome ? "hidden lg:block" : "block text-stone-700"}`}>
          <Link to="/" className="btn btn-ghost text-xl hover:bg-stone-900 rounded-lg transition-colors duration-300 text-shadow-" aria-label="home">
            TLDR History
          </Link>
        </div>
        ...
        <div className="navbar-end flex items-center">
          <div className="dropdown dropdown-end pr-0 md:pr-6">
            ...
            >
              ...
              >
                <div className={`${isHome ? "text-emerald-400" : "text-green-600"} place-items-center w-8 h-8 md:w-12 md:h-12`}>
